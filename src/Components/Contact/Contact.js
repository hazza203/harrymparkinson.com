...
class Contact extends React.Component {
  ...
  formSubmit(event) {
    ...
    if (
      ...
      this.setState({
        message: "Thank you for the message! I will get back to you promptly.",
      });
      this.setState({
        messageStyle: {
          visibility: "visible",
  ...
  render() {
    return (
      <main id={this.props.id} className={contactStyles.container}>
        ...
        <h3 className={contactStyles.message} style={this.state.messageStyle}>
          {this.state.message}
        </h3>
        <Fade bottom fraction={0.4}>
          <form
            method="post"
            action="https://harry-parkinson.prod.with-datafire.io/contact"
