					...
					<nav className={navStyles.smallMenu} style={this.props.fixed ? this.state.fixed : null} id='navbar'>
						<div className={navStyles.wrapper}>
							...
							<div className={navStyles.hiddenMenu} style={this.state.showMenu} >
								<ul>
									<li className={navStyles.hiddenItem}> <Link activeClass={navStyles.active} to="homeSection" spy={true} smooth={true} offset={0} duration= {500} onClick={this.onClick}>Home</Link> </li>
