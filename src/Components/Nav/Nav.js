					...
					<nav className={navStyles.navbar} id='navbar'>	
						<ul className={navStyles.navItems}>
							...
							<div style={{float: 'right'}}>
								<li className={navStyles.social}><a href="https://www.linkedin.com/in/harry-parkinson-418515126/"><span><img src={linkedinIcon} alt="Link to my linked in"/></span></a></li>
								<li className={navStyles.social}><a href="https://github.com/hazza203"><span><img src={githubIcon} alt="Link to my github"/></span></a></li>
								<li className={navStyles.social}><a href="mailto:harry.m.parkinson@gmail.com"><span><img src={emailIcon} alt="Link to my email"/></span></a></li>
							</div>
