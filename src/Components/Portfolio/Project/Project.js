  ...
  onShow() {
    if (
      this.props.show.toLowerCase() ===
        this.props.project.language.toLowerCase() ||
      this.props.show.toLowerCase() === "all"
    ) {
      ...
      <div
        className={
          this.props.transition
            ? projectStyles.animateRemove
            : this.onShow()
            ? projectStyles.projectTile
            : projectStyles.animateRemove
        }
      >
        ...
        <div className={projectStyles.hover}>
          ...
          <span>
            <p className={projectStyles.button} onClick={this.showPreview}>
              LEARN MORE
            </p>
          </span>
        </div>
        {this.state.showPreview !== false ? (
          <div
            id="preview"
            className={projectStyles.preview}
            ...
            <div
              className={`${projectStyles.container} ${
                this.state.showPreview !== true
                  ? projectStyles.fadeOutPreview
                  : null
              }`}
              onMouseEnter={this.onMouseEnterChild}
              onMouseLeave={this.onMouseLeaveChild}
            >
                ...
                <div className={projectStyles.links}>
                  {this.props.project.link !== "" ? (
                    <a href={this.props.project.link}>
                      Demo
                      <img src={siteIcon} alt="Website icon" />
                    </a>
                  ) : null}
                  <a href={this.props.project.github}>
                    Source code <img src={githubIcon} alt="Github icon" />
                  </a>
                  <span onClick={this.removePreview}>
                    <img id="exit" src={closeIcon} alt="Close view button" />
                  </span>
                </div>
              </div>
            </div>
