...
class Welcome extends React.Component {
  constructor(props) {
    ...
    document.documentElement.style.setProperty("--vh", `${this.state.vh}px`);
    ...
    return (
      <header id={this.props.id} className={welcomeStyles.container}>
        <div className={welcomeStyles.wrapper}>
          <h1
            className={`${welcomeStyles.csstyping} ${welcomeStyles.csstyping1}`}
          >
            HELLO.{" "}
          </h1>
          <h1
            className={`${welcomeStyles.csstyping} ${welcomeStyles.csstyping2}`}
          >
            {" "}
            I'M HARRY PARKINSON.
          </h1>
          <h1
            className={`${welcomeStyles.csstyping} ${welcomeStyles.csstyping3}`}
          >
            {" "}
